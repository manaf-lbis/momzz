...
import { useGetJobCardsQuery, useCreateJobMutation } from '../../jobs/api/jobApi';
import { useGetPendingWorkersQuery, useGetLeaderboardQuery } from '../../auth/api/authApi';
import { VehicleCard } from '../../../shared/components/jobCard/VehicleCard';
import {
  Shield,
  Plus,
  Wrench,
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 flex flex-col transition-colors duration-200">
      ...
      <main className="app-container relative z-10 flex-1 py-6 pb-36 sm:pb-40 md:pb-16 space-y-6">
        ...
        <header className="sticky top-0 sm:top-14 z-30 -mx-4 px-4 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8 -mt-6 pt-3.5 pb-3.5 mb-2 glass-modern-header flex items-center justify-between gap-3 transition-all">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs font-mono text-zinc-500 dark:text-zinc-400">
                ADMIN: <span className="text-amber-600 dark:text-yellow-400 font-bold uppercase">{user?.name}</span>
              </p>
            </div>
          </div>
