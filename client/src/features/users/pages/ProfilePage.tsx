            ...
            <section className="relative overflow-hidden rounded-3xl bg-white/95 dark:bg-[#12131F]/90 backdrop-blur-2xl border border-slate-200/80 dark:border-white/[0.08] p-5 shadow-xl space-y-4 transition-colors">
              ...
              <div className="flex flex-col items-center text-center space-y-3">
                ...
                <div className="relative group">
                  <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full overflow-hidden bg-gradient-to-br from-amber-400/20 to-slate-200 dark:from-slate-700 dark:to-slate-800 border-2 border-amber-400/40 flex items-center justify-center font-black text-2xl text-slate-800 dark:text-white shadow-xl">
                ...
                <div>
                  ...
                  <p className="text-[10px] font-mono text-slate-400 dark:text-slate-500 mt-2 flex items-center justify-center gap-1">
          ...
          <div className="lg:col-span-7 space-y-4">
            <section className="rounded-3xl bg-white/95 dark:bg-[#12131F]/90 backdrop-blur-2xl border border-slate-200/80 dark:border-white/[0.08] shadow-xl p-4 sm:p-5 space-y-3.5 transition-colors">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                ...
                >
                  <div className="w-9 h-9 rounded-xl bg-sky-500/15 text-sky-500 dark:text-sky-400 flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform">
                ...
                {isAdmin && (
                  <>
                    ...
                    >
                      <div className="w-9 h-9 rounded-xl bg-emerald-500/15 text-emerald-500 dark:text-emerald-400 flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform">
                        <Package className="w-4.5 h-4.5" />
                      </div>
                      <div className="min-w-0 flex-1">
                        <h4 className="text-xs font-bold text-slate-900 dark:text-white group-hover:text-emerald-500 dark:group-hover:text-emerald-300 transition-colors">
                          Inventory Stock
                        </h4>
                        <p className="text-[10px] text-slate-500 dark:text-slate-400 mt-0.5 leading-snug">
                    ...
                    <button
                      ...
                      className="p-3.5 rounded-2xl bg-slate-50 hover:bg-slate-100 dark:bg-white/[0.02] dark:hover:bg-white/5 border border-slate-200/80 dark:border-white/[0.06] hover:border-rose-400/40 transition text-left flex items-start gap-3 group cursor-pointer"
                    >
                      <div className="w-9 h-9 rounded-xl bg-rose-500/15 text-rose-500 dark:text-rose-400 flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform">
                        <ShoppingCart className="w-4.5 h-4.5" />
                      </div>
                      <div className="min-w-0 flex-1">
                        <h4 className="text-xs font-bold text-slate-900 dark:text-white group-hover:text-rose-500 dark:group-hover:text-rose-300 transition-colors">
                          POS Billing
                        </h4>
                        <p className="text-[10px] text-slate-500 dark:text-slate-400 mt-0.5 leading-snug">
            ...
            <section className="rounded-3xl bg-white/95 dark:bg-[#12131F]/90 backdrop-blur-2xl border border-slate-200/80 dark:border-white/[0.08] p-4 shadow-xl flex items-center justify-between gap-3 transition-colors">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="text-xs font-bold text-slate-900 dark:text-white">Workshop Support Hotline</h4>
                  <p className="text-[10px] text-slate-500 dark:text-slate-400">+91 9747382525</p>
                </div>
              </div>
              <a
                href="tel:+919747382525"
                className="px-3 py-1.5 rounded-xl bg-emerald-500 text-white dark:text-slate-950 font-black text-xs hover:bg-emerald-600 dark:hover:bg-emerald-400 transition active:scale-95 shadow-xs"
              >
                Call
              </a>
            </section>
        ...
        {isLogoutModalOpen && (
          <div className="fixed inset-0 z-[70] flex items-center justify-center p-4 pb-24 sm:pb-4 bg-black/60 dark:bg-black/80 backdrop-blur-md">
            <motion.div
              ...
              className="relative w-full max-w-sm rounded-3xl bg-white dark:bg-[#0f0f1e] border border-slate-200 dark:border-white/12 shadow-2xl p-6 text-center space-y-4"
            >
              <div>
                <h3 className="text-base font-black text-slate-900 dark:text-white">Sign Out</h3>
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Are you sure you want to log out of MOMZ'Z OS?</p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-2.5 pt-2">
                <button
                  ...
                  className="py-2.5 px-4 rounded-xl border border-slate-200 dark:border-white/10 bg-slate-100 hover:bg-slate-200 dark:bg-white/5 text-slate-700 dark:text-slate-300 font-bold text-xs dark:hover:bg-white/10 cursor-pointer"
                >
                  Cancel
                </button>
                <button
            ...
            >
              <div className="flex items-center justify-between">
                <h3 className="text-base font-black text-slate-900 dark:text-white flex items-center gap-2">
                  <Lock className="w-4 h-4 text-amber-500 dark:text-amber-400" /> Change Password
                </h3>
                <button
              ...
              <form onSubmit={handleChangePassword} className="space-y-3">
                <div>
                  <label className="text-[10px] font-mono text-slate-500 dark:text-slate-400 uppercase">Current Password</label>
                  <input
                    type="password"
                    required
                    value={currentPassword}
                    onChange={(e) => setCurrentPassword(e.target.value)}
                    className="w-full mt-1 px-3 py-2 rounded-xl bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 text-xs font-bold text-slate-900 dark:text-white outline-none focus:border-amber-400"
                  />
                </div>

                <div>
                  <label className="text-[10px] font-mono text-slate-500 dark:text-slate-400 uppercase">New Password</label>
                  <input
                    type="password"
                    required
                    minLength={6}
                ...
                <div className="flex gap-2 pt-2">
                  ...
                  <button
                    type="button"
                    onClick={() => setIsPasswordModalOpen(false)}
                    className="px-4 py-2.5 rounded-xl bg-slate-100 dark:bg-white/5 text-slate-700 dark:text-slate-300 font-bold text-xs"
                  >
                    Cancel
                  </button>
                </div>
