...
export const WorkLogsPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen glass-canvas text-slate-900 dark:text-slate-100 flex flex-col transition-colors duration-200">
      ...
      <main className="app-container relative z-10 flex-1 py-4 sm:py-6 space-y-4 sm:space-y-5 pb-36 sm:pb-40 md:pb-16">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-10 py-2.5 sm:py-3 glass-modern-card rounded-2xl text-xs sm:text-sm text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-amber-400/40 shadow-xs transition"
          />
          {searchQuery && (
            <button
        ...
        {isJobsLoading ? (
          ...
          <div className="py-12 px-4 rounded-3xl glass-modern-card text-center space-y-2">
                ...
                <div className="space-y-2">
                  {logs.map((log, idx) => (
                    <motion.div
                      ...
                      className="glass-modern-card rounded-2xl p-3.5 sm:p-4 shadow-xs transition cursor-pointer active:scale-[0.99]"
                    >
