...
import { CatalogItem, useGetCatalogQuery, useGetCategoriesQuery } from '../../catalog/api/catalogApi';
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-0.5 text-xs sm:text-sm font-mono text-slate-500 dark:text-slate-400">
                Manage products and services for job cards & direct POS billing
              </p>
            </div>
          </div>
