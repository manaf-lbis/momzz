  ...
  return (
    <div className="min-h-screen bg-zinc-100 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 flex flex-col transition-colors">
      ...
      <main className="flex-1 max-w-5xl w-full mx-auto px-4 sm:px-6 py-5 space-y-5">
        ...
        {/* ── View Tabs ── */}
        <div className="flex gap-1.5 p-1 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl shadow-xs">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl text-xs sm:text-sm text-zinc-900 dark:text-zinc-100 placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-amber-500/40 shadow-xs transition-all"
          />
        </div>
                  ...
                  >
                    ...
                    {job.customerName && (
                      <p className="text-[11px] text-zinc-500 dark:text-zinc-400 font-medium truncate">
                        👤 {job.customerName}
                        {job.customerMobile && <span className="text-zinc-400 ml-1 font-mono">· {job.customerMobile}</span>}
                      </p>
                    )}
