    ...
    <div className="min-h-screen bg-[#080810] text-white flex flex-col overflow-x-hidden selection:bg-amber-400/20">
      ...
      <main className="relative z-10 flex-1 max-w-6xl w-full mx-auto px-3 sm:px-6 py-4 pb-32 space-y-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
          <div className="p-3 rounded-2xl bg-white/[0.03] backdrop-blur-xl border border-white/10 flex items-center justify-between">
            <div>
              <p className="text-[10px] font-mono uppercase text-slate-400">Total Staff</p>
              <p className="text-lg font-black text-white">{rawUsers.length}</p>
            </div>
          ...
          <div className="p-3 rounded-2xl bg-white/[0.03] backdrop-blur-xl border border-white/10 flex items-center justify-between">
            <div>
              <p className="text-[10px] font-mono uppercase text-slate-400">Live Active</p>
          ...
          <div className="p-3 rounded-2xl bg-white/[0.03] backdrop-blur-xl border border-white/10 flex items-center justify-between">
            <div>
              <p className="text-[10px] font-mono uppercase text-slate-400">Admins</p>
          ...
          <div className="p-3 rounded-2xl bg-white/[0.03] backdrop-blur-xl border border-white/10 flex items-center justify-between">
            <div>
              <p className="text-[10px] font-mono uppercase text-slate-400">Mechanics</p>
              <p className="text-lg font-black text-amber-300">{workerCount}</p>
            </div>
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2 rounded-xl bg-white/[0.03] backdrop-blur-xl border border-white/10 focus:border-amber-400/50 focus:ring-1 focus:ring-amber-400/20 text-xs font-bold text-white placeholder-slate-500 outline-none transition"
            />
            {search && (
              <button
                onClick={() => setSearch('')}
          ...
          {/* Filter Tabs */}
          <div className="flex gap-1 p-1 bg-white/[0.04] rounded-2xl border border-white/8 overflow-x-auto">
            {(
              [
            ...
            {filteredUsers.map((u: User) => {
              ...
              return (
                <motion.div
                  ...
                  className="group relative overflow-hidden rounded-2xl bg-white/[0.03] backdrop-blur-2xl border border-white/[0.08] hover:border-amber-400/40 p-3.5 flex flex-col justify-between transition-all duration-200 cursor-pointer shadow-lg shadow-black/30"
                >
                  ...
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <div className="flex items-center gap-3 min-w-0">
                      <div className="relative shrink-0">
                        <div className="w-11 h-11 rounded-2xl overflow-hidden bg-slate-800 border border-white/10 flex items-center justify-center font-black text-sm text-white shadow-xs">
                          {u.profileImageUrl ? (
                      ...
                      <div className="min-w-0 flex-1">
                        <h3 className="text-sm font-black text-white truncate group-hover:text-amber-200 transition-colors">
                          {u.name}
                        </h3>
                    ...
                    <div className="flex items-center text-slate-400 group-hover:text-amber-300 transition-colors shrink-0">
