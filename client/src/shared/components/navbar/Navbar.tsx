...
export const Navbar: React.FC<{ glass?: boolean }> = ({ glass = false }) => {
  ...
  return (
    <>
      <header className={`hidden sm:block sticky top-0 z-50 backdrop-blur-2xl border-b transition-colors ${glass ? 'bg-white/80 dark:bg-[#080810]/80 border-slate-200/80 dark:border-white/10 shadow-xs' : 'bg-white/95 dark:bg-[#080810]/95 border-slate-200/80 dark:border-white/10'}`}>
