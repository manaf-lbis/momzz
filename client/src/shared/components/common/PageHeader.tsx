...
export const PageHeader: React.FC<PageHeaderProps> = ({
  ...
  return (
    <header
      className={`sticky top-0 sm:top-14 z-30 -mx-4 px-4 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8 -mt-4 pt-3.5 pb-3.5 mb-3 glass-modern-header transition-all flex flex-row items-center justify-between gap-2 sm:gap-4 ${className}`}
    >
